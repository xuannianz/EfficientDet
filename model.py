...
def build_wBiFPN(features, num_channels, id, freeze_bn=False):
    if id == 0:
        ...
        P6_td = layers.Lambda(lambda x: tf.nn.swish(x))(P6_td)
        ...
        P5_td = layers.Lambda(lambda x: tf.nn.swish(x))(P5_td)
        ...
        P4_td = layers.Lambda(lambda x: tf.nn.swish(x))(P4_td)
        ...
        P3_out = layers.Lambda(lambda x: tf.nn.swish(x))(P3_out)
        ...
        P4_out = layers.Lambda(lambda x: tf.nn.swish(x))(P4_out)
        ...
        P5_out = layers.Lambda(lambda x: tf.nn.swish(x))(P5_out)
        ...
        P6_out = layers.Lambda(lambda x: tf.nn.swish(x))(P6_out)
        ...
        P7_out = layers.Lambda(lambda x: tf.nn.swish(x))(P7_out)
